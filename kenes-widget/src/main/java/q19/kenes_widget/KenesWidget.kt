...
import q19.kenes_widget.ui.presentation.KenesWidgetActivity
    ...
    class Builder constructor(private var hostname: String) {
        ...
        fun build(context: Context): Intent {
            val language = when (language) {
                Language.KK -> q19.kenes_widget.data.model.Language.KAZAKH
                Language.RU -> q19.kenes_widget.data.model.Language.RUSSIAN
                else -> null
            }
